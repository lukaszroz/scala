            ...
            switch (buf[i]) {
                ...
                case '\\':
                    if (buf[i + 1] == '=' || buf[i + 1] == '>') {
                        ...
                        writeString(out, "\\color{red}");
                        i++;
                    } else if (buf[i + 1] == 'S') {
                        writeString(out, "\\color{black}");
                        i++;
                    } else if (buf[i + 1] == 'B') {
                        writeString(out, "\\color{blue}");
                        i++;
                    } else if (buf[i + 1] == 'G') {
                        writeString(out, "\\color{green}");
                        i++;
                    } else {
